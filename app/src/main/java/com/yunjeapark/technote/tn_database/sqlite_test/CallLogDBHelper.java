package com.yunjeapark.technote.tn_database.sqlite_test;
...
public class CallLogDBHelper extends SQLiteOpenHelper {
    ...
    public CallLogDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE  CallLogTable(_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, phone_number TEXT, call_date TEXT, type TEXT);");
    }
    // DB 업그레이드를 위해 버전이 변경될 때 호출되는 함수
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    }
    public void insert(String name, String phone_number, String call_date, String type) {
        // 읽고 쓰기가 가능하게 DB 열기
