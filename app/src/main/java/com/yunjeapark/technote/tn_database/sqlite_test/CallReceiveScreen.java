...
public class CallReceiveScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receive.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                finish();
                Toast.makeText(CallReceiveScreen.this, "받음", Toast.LENGTH_SHORT).show();
            }
        });
        cancel.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                finish();
                Toast.makeText(CallReceiveScreen.this, "끊음", Toast.LENGTH_SHORT).show();
            }
        });
    }
}