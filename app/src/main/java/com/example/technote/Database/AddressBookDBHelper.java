...
public class AddressBookDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE AdressBookList (_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, phone_number INTEGER);");
    ...
    public void insert(String name, int phone_number) {
        // 읽고 쓰기가 가능하게 DB 열기
    ...
    public void update(String name, int phone_number) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public void delete(String name) {
        SQLiteDatabase db = getWritableDatabase();
        // 입력한 항목과 일치하는 행 삭제
        db.execSQL("DELETE FROM AdressBookList WHERE name='" + name + "';");
        db.close();
    }
