...
public class AddressBookDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE AdressBookList (_id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, phone_number VARCHAR NOT NULL);");
    }
    ...
    public long getProfilesCount() {
        ...
        long count = DatabaseUtils.queryNumEntries(db, "AdressBookList");
        db.close();
        return count;
    }
}