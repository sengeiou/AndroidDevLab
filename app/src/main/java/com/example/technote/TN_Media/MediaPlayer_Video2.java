...
public class MediaPlayer_Video2 extends AppCompatActivity {
    static VideoView videoView;
    static MyMediaController2 controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mediaplayer_video_view2);
        ...
        controller = new MyMediaController2(this);
